# bookshelf - AI Assistant Instructions

**Package**: `@apps/bookshelf`
**Version**: 0.1.0
**Type**: apps package

## Package Overview

**Description**: Bookshelf Manager - Digital library and reading list

**Purpose**: Provide bookshelf manager - digital library and reading list functionality for the pkgs ecosystem.
...
**Executables**:
- `.local/bin/bookshelf` - Main executable
...
1. **Test installation**: `stow bookshelf`
2. **Test functionality**: Run main commands and verify output
3. **Test uninstallation**: `stow -D bookshelf`
